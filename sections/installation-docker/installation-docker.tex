...
\subsection[Aperçu]{Aperçu\label{sec:suite_installation}}
    ...
    \begin{itemize}
        ...
        \item Volumes: Cet onglet contient les volumes liés aux services qui contiennent les données de nos applications. Les volumes servent à conserver les données des bades de données lorsque nous éteignons un container et qu'on le relance.
