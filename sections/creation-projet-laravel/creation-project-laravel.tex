...
\subsection[Création d'un nouveau projet]{Création d'un nouveau projet\label{sec:new_project}}
    \subsubsection[Création du dossier]{Création du dossier}
        ...
        Une fois le dossier du projet créé, entrez dans le dossier du site (\textit{File} $\rightarrow$ \textit{Open Folder\ldots}) et ouvrir le fichier \verb|docker-compose.yml|.
